  ...
  return (
    ...
    >
      ...
      <div className="flex gap-1">
        <button className="w-2/3 h-full p-2 font-bold text-white bg-blue-600 rounded hover:bg-blue-500">
          Search
        </button>
        <button className="w-1/3 h-full p-2 font-bold text-white rounded bg-rose-600 hover:bg-rose-500">
          Clear
        </button>
      </div>
    </form>
